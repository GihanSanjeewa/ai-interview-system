    ...
    <div className="report-container">
      ...
      <main className="report-grid">
        <section className="score-cards">
          ...
          <div className="score-card">
            ...
            <div className="score-circle fluency">
              <span>{report.fluency_score ?? "—"}</span>
              <span className="score-max">/100</span>
            </div>
          </div>
          <div className="score-card">
            ...
            <div className="score-circle speed">
              <span>{report.speaking_speed_score ?? "—"}</span>
              <span className="score-max">/100</span>
            </div>
          </div>
          <div className="score-card">
            ...
            <div className="score-circle relevance">
              <span>{report.response_relevance_score ?? "—"}</span>
              <span className="score-max">/100</span>
            </div>
          </div>
        </section>
        ...
        <div className="ml-badge">
          <Activity size={13} /> Scores computed by ML: librosa audio analysis + spaCy NLP +
          TF-IDF similarity
        </div>

        <section className="glass-card summary-card">
          <h2>
            <Award size={18} className="icon" /> Overall Summary
          </h2>
          <p>{report.summary}</p>
        </section>
        ...
        <div className="details-grid">
          <section className="glass-card">
            <h2>
              <CheckCircle size={18} className="icon green" /> Key Strengths
            </h2>
            <ul>
          ...
          <section className="glass-card">
            <h2>
              <AlertCircle size={18} className="icon orange" /> Areas for Improvement
            </h2>
            <ul>
        ...
        {report.learning_resources?.length > 0 && (
          <section className="glass-card">
            <h2>
              <BookOpen size={18} className="icon purple" /> Recommended Learning Resources
            </h2>
        ...
        <section className="glass-card jobs-card">
          <h2>
            <Briefcase size={18} className="icon blue" /> Job Recommendations
          </h2>
