...
exports.PHASES = exports.QUESTION_BANK = exports.TRACKS = void 0;
...
function pickQuestions(category) {
    ...
    const id = exports.QUESTION_BANK[category] ? category : (legacy[category] ?? "software_engineering");
    return exports.QUESTION_BANK[id].slice();
}
